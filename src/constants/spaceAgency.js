export const spaceAgencies = [
    ...
    },
    {
        ...
        that is responsible for civil space administration and international space cooperation,
         including organizing or leading foreign exchanges and cooperation in the aerospace field.
         [need quotation to verify] An administrative agency under the Ministry of Industry and Information 
    ...
    },
    {
      ...
      ISRO acts as the executive of DOS as well. ISRO is India's primary agency for performing tasks 
      related to space-based applications, space exploration and the development of related technologies.
       It is one of six government space agencies in the world which possess full launch capabilities, deploy cryogenic engines, 
    ...
    },
    {
      ...
      SpaceX is developing a satellite internet constellation named Starlink to provide commercial internet service.
       In January 2020, the Starlink constellation became the largest satellite constellation ever launched, and as of September
        2022 comprises over 3,000 small satellites in orbit.[7] The company is also developing Starship, a privately funded, fully reusable, 
        super heavy-lift launch system for interplanetary and orbital spaceflight. It is intended to become SpaceX's primary orbital vehicle once operational, 
        supplanting the existing Falcon 9, Falcon Heavy, and Dragon fleet. It will have the highest payload capacity of any orbital rocket ever built on its debut, 
    ...
    },
    {
        ...
        details: `Blue Origin, LLC is an American privately funded aerospace manufacturer and sub-orbital spaceflight services company
         ...
         is led by CEO Bob Smith and aims to make access to space cheaper and more reliable through reusable launch vehicles.[5][6] Rob Meyerson
          led Blue Origin from 2003 to 2017 and served as its first president.[7] Blue Origin is employing an incremental approach from suborbital
           to orbital flight,[citation needed] with each developmental step building on its prior work.[8] The company's name refers to the blue planet,
            Earth, as the point of origin.[9]

        Blue Origin develops orbital technology, rocket-powered vertical takeoff and vertical landing (VTVL) vehicles for access to suborbital and orbital
         space.[10] Initially focused on suborbital spaceflight, the company has designed, built and flown multiple testbeds of its New Shepard vehicle at 
         its facilities in Culberson County, Texas. Developmental test flights of the New Shepard,[11] named after the first American in space Alan Shepard,
          began in April 2015, and flight testing is ongoing.[12][13] Blue Origin rescheduled the original 2018 date for first passengers several times, and 
          eventually successfully flew its first crewed mission on July 20, 2021.[14] It has not yet begun commercial passenger flights, nor announced a firm 
